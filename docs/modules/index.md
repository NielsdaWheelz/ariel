...
- [ai-judgments.md](ai-judgments.md): append-only audit log for bounded AI model calls
- [attachments.md](attachments.md): attachment content ingestion and extraction
- [gmail-evidence-schema.md](gmail-evidence-schema.md): typed-output contract for
  `google.gmail.message_evidence.v1` — top-level shape, `evidence` / `read_outcome`
  bounding, body-digest invariant, hidden-content policy, message metadata bounds
- [google-workspace-reasoning-cutover.md](google-workspace-reasoning-cutover.md): Gmail,
  Calendar, commitment, due-date, and follow-up reasoning
