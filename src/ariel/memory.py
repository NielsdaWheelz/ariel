...
def run_retriever(
    *,
    ...
    cfg = LoopConfig(
        ...
        model_ref=MAIN,
        budget_seconds_soft=float(settings.memory_recall_budget_seconds),
        budget_seconds_hard=float(settings.memory_recall_budget_seconds),
        max_model_calls_soft=int(settings.agent_loop_max_model_calls),
        max_model_calls_hard=int(settings.agent_loop_max_model_calls),
...
def run_rememberer(
    *,
    ...
    cfg = LoopConfig(
        ...
        model_ref=MAIN,
        budget_seconds_soft=budget,
        budget_seconds_hard=budget,
        max_model_calls_soft=int(settings.agent_loop_max_model_calls),
        max_model_calls_hard=int(settings.agent_loop_max_model_calls),
        is_main_agent_loop=False,
        record_judgments=True,
