...
RUN_CALLABLE_SIGNATURES: dict[str, str] = {
    ...
    # memory.*
    "memory.search": "(query: str, limit: int = 24, since: str | None = None, kinds: list[str] | None = None)",
    "memory.read": "(id: str)",
    "memory.recall": "(query: str)",
    "memory.remember": "(note: str)",
    "memory.note.create": "(content: str)",
    "memory.note.edit": "(id: str, content: str)",
    "memory.note.delete": "(id: str)",
    # search / web
